                ...
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 pt20">
                    ...
                    <div class="login100-form validate-form">
                        ...
                        <div class="nm-accss">
                            ...
                            <div class="div ttl-er-page">Waktu Login Berakhir</div>
                            <div class="div lbl">Aktivitas login Anda telah berkahir. Silahkan login kembali.</div>
                            <div class="div">
                                <a href="{{$URI}}"><span class="zmdi zmdi-arrow-left"></span> Login Kembali</a>
                            </div>
                        </div>
