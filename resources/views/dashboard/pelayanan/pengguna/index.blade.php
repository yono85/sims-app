        ...
        <div class="in-tables">
            ...
            <div class="div head-tables">
                <div class="div clr-float">
                    ...
                    <form action="/api/pelayanan/pengguna/table" id="form-table" aria-temp="temp-table">
                            ...
                            <div class="td-iner">
                                <div class="div">
                                    ...
                                    <div class="div label fsize12">
                                        <span class="label ic far fa-address-card fsize10"></span>
                                        <span>{sublevel}</span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog w460" role="document">
        <div class="modal-content br-rds12 pd-tb15 pd-lr15">
            <div class="modal-header txt-center no-br">
                <div class="div">
                    <h2 class="modal-title">
                        <span class="fsize18">Tambah User</span>
                    </h2>
                    <div class="div">
            ...
            <div class="modal-body">
                <div class="div">
                    <form action="/api/pelayanan/pengguna/create" id="form-create">
                        ...
                        <div class="div">
                            ...
                            <div class="div">
                                <div class="div">
                                    <div class="divx">
                                        <span class="label font-wg25 up-txt fsize9">Cari Lembaga</span>
                                        <div class="div">
                                            <div class="field-city indropdown area-tsrc-dropdown alist" role="false" datatimer="1000">
                                                <div class="div ar-content dot-mandatory">
                                                    <input class="form-control br-rds4  txt-def-empty tsrc-dropdown label-dropdown txt empty" name="lembaga" type="text" placeholder="Cari Lembaga..." aria-href="/api/data/src-lembaga?pg=1&q=" maxlength="75">

                                                    <input type="hidden" name="lembaga_id" class="value-dropdown empty">
                            ...
                            <div class="div">
                                <div class="div">
                                    ...
                                    <div class="ddwn area-ddwn ar-content keep w50p ddwn-button-select area-select-gender dot-mandatory" data-label="Pilih Gender">
                                        <button class="btn br-rds8 cddwn" role="off">
...
function createTempTable(e,w)
{
    ...
    $.each(rsp.list,function(i,item)
    {
        ...
        listx = listx.replace('{sublevel}', item.lembaga + ' (' + item.sublevel + ')' );
...
$(document).ready(function()
{
    ...
    $(".cmd-modal-create").click(function(e)
    {
        ...
        if(cmd.attr("role") === "off")
        {
            ...
            modal.find(".modal-title span").html("Tambah User");
    ...
    $("body").on("click", ".cmd-sunting", function(e)
    {
        ...
        if(cmd.attr("role") === "off")
        {
            ...
            modal.find(".modal-title span").html("Sunting User");

            modal.find("input[name='user_id']").val(getaccount().id);

            var $URL = config.apps.URL_API + '/api/admin/manage/view?id='+id;
    ...
    function checkFormCreate(w)
    {
        ...
        lembaga_id = form.find('*[name="lembaga_id"]'),
        button = modal.find('button.modal-submit');
        ...
        //
        if( $.trim(name.val()).length < 3  || $.trim(gender.val()) === '' || $.trim(phone.val()).length < 9 || $.trim(lembaga_id.val()) === '' || !validateEmail(email.val()) )
        {
            ...
            if( $.trim(gender.val()) === '' )
            {
                gender.parent('.ar-content').append('<span class="error">Pilih gender</span>');
                gender.parent('.ar-content').find("button").addClass('br-error');
            }

            if( $.trim(phone.val()).length < 9 )
            {
                phone.parent('.ar-content').append('<span class="error">No Whatsapp sekurangnya 9 karakter</span>');
            ...
            {
                email.parents('.ar-content').append('<span class="error">Isikan dengan email valid</span>');
                email.addClass('br-error');
            }

            if( $.trim(lembaga_id.val()) === '' )
            {
                lembaga_id.parent('.ar-content').append('<span class="error">Tentukan Lembaga</span>');
                lembaga_id.parent('.ar-content').find("*[name='lembaga']").addClass('br-error');
            }
