        ...
        <div class="in-tables">
            ...
            <div class="div head-tables">
                <div class="div clr-float">
                    ...
                    <form action="/api/inventory/order/table" id="form-table" aria-temp="temp-table">
                                                    ...
                                                    <div class="ddwn area-ddwn keep area-status">
                                                        ...
                                                        <div class="ddwn-pg area-ddwn-page">
                                                            <ul>
                                                                ...
                                                                <li aria-selected="false">
                                                                    <button role="off"  dataid="2" ><span>Progress</span></button>
                                                                </li>
                                                                <li aria-selected="false">
            ...
            <table>
                <tbody>
                    <tr>
                            ...
                            <div class="td-iner">
                                <div class="div">
                                    ...
                                    <div class="div label fsize12">
                                        <span class="label ic sli_icon-user"></span>
                                        <span>{marketing}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="td-w150 wh-m-520">
                            <div class="td-iner">
                                <div class="div">
                                    <span><span class="ic label sli_icon-calendar"></span> {startdate}</span>
                                </div>
                                <div class="div">
                                    <div class="div label">s.d.</div>
                                    <span><span class="ic label sli_icon-calendar"></span> {enddate}</span>
                                </div>
                            </div>
                        </td>
                        <td class="td-w230 wh-m-520">
                            <div class="td-iner">
                                <div class="div">
                                    <span><span class="ic label far fa-address-card"></span> {customer}</span>
                                </div>
                                <div class="div label">
...
function createTempTable(e,w)
{
    ...
    $.each(rsp.list,function(i,item)
    {
        ...
        listx = listx.replace('{marketing}', item.marketing);
        listx = listx.replace('{register}', (item.progress === 2 ? '<li class="progress"><span>PROGRESS</span></li>' : '<li class="done"><span>DONE</span></li>'));
        ...
        {
            li += '<li class="dotli">'+y.name+' <span class="label"> ('+y.code+')</span></li>';
        });
        listx = listx.replace('{operasional}', li);
