        ...
        <div class="in-tables">
            ...
            <div class="div head-tables">
                <div class="div clr-float">
                    ...
                    <form action="/api/inventory/tools/table" id="form-table" aria-temp="temp-table-invantory">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="td-w230">
                                                <div class="td-iner">
                                                    <span class="ic fa flaticon2-indent-dots"></span>
                                                    <span>ASSESORIS</span>
                                                </div>
                                            </td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-w160 wh-m-520">
                            <div class="td-iner">
                                <div class="div">
                                    <span>{kalibrasi_date}</span>
                                </div>
                            </div>
                        </td>
                        <td class="td-w90 wh-m-520">
                            <div class="td-iner">
                                <div class="div">
                                    <span>{stock}</span>
                                </div>
            ...
            <div class="insed-body h-full pdtb20">
                ...
                <div class="arinsed mdl-partner pd-lr-40 pos-rel m-pd-lr25">
                    ...
                    <div class="div header-box">
                        <b class="title">Tambah Alat</b>
                        <a href="#" class="close afalse" role="off">
                            <span class="fa flaticon2-cross"></span>
                        </a>
                    </div>
                    <form action="/api/inventory/tools/create" id="form-create" >
                                    ...
                                    <table>
                                        <tr>
                                            <td class="left">
                                                <div class="div">
                                                    <div class="div">
                                                        <b>Nama Alat dan Serial Number</b>
                                                    </div>
                                                    <div class="div label">Isikan nama alat dan serial number
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="vtop">
                                                ...
                                                <div class="div">
                                                    <div class="div hide ws-m-disb-620">
                                                        <b class="up-txt fsize9">NAMA ALAT</b>
                                                    </div>

                                                    <div class="div ar-content dot-mandatory">
                                                        <input type="text" class="w100p form-control empty" placeholder="Nama Alat" maxlength="75" name="name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="div w50p">
                                                    <div class="div hide ws-m-disb-620">
                                                        <b class="up-txt fsize9">Serial Number</b>
                                                    </div>

                                                    <div class="div ar-content dot-mandatory">
                                                        <input type="text" class="w100p form-control empty" placeholder="Serial Number" maxlength="50" name="code">
                                                    </div>
                                                </div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td class="left">
                                                <div class="div">
                                                    <div class="div">
                                                        <b>Jumlah, Jenis alat dan Asesoris</b>
                                                    </div>
                                                    <div class="div label">Isikan Jumlah, Jenis alat dan Asesoris terkait
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="vtop">
                                                ...
                                                <div class="div w50p">
                                                    <div class="div hide ws-m-disb-620">
                                                        <b class="up-txt fsize9">JUMLAH ALAT</b>
                                                    </div>

                                                    <div class="div ar-content dot-mandatory">
                                                        <input type="text" class="w100p form-control empty rupiahkeyup" placeholder="Jumlah alat" maxlength="9" name="quantity">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="ddwn area-ddwn ddwn-button-select ar-content keep dot-mandatory area-types" data-label="Pilih Jenis">
                                                        ...
                                                        <div class="ddwn-pg area-ddwn-page">
                                                            <ul>
                                                                <!-- list -->
                                                                <!-- <li aria-selected="false">
                                                                    <button role="off" dataid="1" data-modal="" data-modal-label="" data-get=""><span>Alat Berat</span></button>
                                                                </li>
                                                                <li aria-selected="false">
                                                                    <button role="off" dataid="2" data-modal="" data-modal-label="" data-get=""><span>Alat Sedang</span></button>
                                                                </li>
                                                                <li aria-selected="false">
                                                                    <button role="off" dataid="3" data-modal="" data-modal-label="" data-get=""><span>Alat Ringan</span></button>
                                                                </li> -->
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="div area-list-label">
                                                    <div class="div">
                                                        <ul class="ul-ass empty-label"></ul>
                                                    </div>
                                                    <div class="div">
                                                        <textarea name="assesoris_label" class="form-control empty" maxlength="250" placeholder="Assesoris..."></textarea>
                                                        <div class="div clr-float mg-t5">
                                                            <button role="off" class="btn green fl-right">
                                                                <span>Tambah</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="div">
                                                        <textarea name="assesoris" class="hide empty"></textarea>
                                                    </div>
                                                </div>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td class="left">
                                                <div class="div">
                                                    <div class="div">
                                                        <b>Status Kalibrasi</b>
                                                    </div>
                                                    <div class="div label">Tentukan Status Kalibrasi.
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="vtop">

                                                <div class="ddwn area-ddwn ddwn-button-select ar-content keep dot-mandatory w50p area-kalibrasi-status" data-label="Status Kalibrasi">

                                                    <button class="btn br-rds8 cddwn fcs" role="off">
                                                        <label><span class="fsize14 color-black">Status Kalibrasi</span></label>
                                                    </button>
                                                    ...
                                                    <div class="ddwn-pg area-ddwn-page">
                                                        <ul>
                                                            <!-- list -->
                                                            <li aria-selected="false">
                                                                <button role="off" dataid="1" data-modal="" data-modal-label="" data-get="" ><span>Kalibrasi</span></button>
                                                            </li>
                                                            <li aria-selected="false">
                                                    ...
                                                    <input type="hidden" class="value-dropdown empty" name="kalibrasi_status" value="">
                                                ...
                                                <div class="div hide area-hidden">
                                                    ...
                                                    <div class="div w50p">
                                                        <div class="div hide ws-m-disb-620">
                                                            <b class="up-txt fsize9">TANGGAL KALIBRASI</b>
                                                        </div>
                                                        <div class="div ar-content">
                                                            <div class="se-date no-clr" role="off">
                                                                <input type="input" name="kalibrasi_date" class="w100p form-control background-trf position-rt inputFalseAll empty singleDate typefalse" placeholder="Tanggal Kalibrasi" >
                                                                <span class="ar-ic">
                                                    ...
                                                    <div class="ddwn area-ddwn ddwn-button-select ar-content keep w50p area-select-durasi-reminder" data-label="1 hari">
                                                        ...
                                                        <div class="ddwn-pg area-ddwn-page">
                                                            <ul>
                                                                <!-- list -->
                                                                <!-- <li aria-selected="false">
                                                                    <button role="off" dataid="1" data-modal="" data-modal-label="" data-get="" ><span>1 hari</span></button>
                                                                </li>
                                                                <li aria-selected="false">
                                                                    <button role="off" dataid="2" data-modal="" data-modal-label="" data-get="" ><span>2 hari</span></button>
                                                                </li> -->
                                                            </ul>
                                                        </div>
                                                        <div class="div">
...
function createTempTable(e,w)
{
    ...
    $.each(rsp.list,function(i,item)
    {
        ...
        listx = listx.replace('{kalibrasi_date}', item.kalibrasi_date);
        listx = listx.replace('{name}', item.name);
        listx = listx.replace('{stock}', formatRupiah( item.quantity) );
        listx = listx.replace('{type}', item.type_name);
        listx = listx.replace('{stock}', item.stock);

        // listx = listx.replace('{assesoris}', item.assesoris);

        if( item.assesoris !== '')
        {
            var lidot= '';
            $.each(item.assesoris, function(x, y)
            {
                lidot += '<li class="dotli">'+y+'</li>';
            });

            listx = listx.replace('{assesoris}', lidot);
        }
        else
        {
            listx = listx.replace('{assesoris}', '--');
        }
...
async function gettypes(w,e)
{
    ...
    var $URL = config.apps.URL_API + '/api/inventory/tools/data/types';
...
$(document).ready(function()
{
    ...
    $(".cmd-modal-create").click(function(e)
    {
        ...
        if(cmd.attr("role") === "off")
        {
            ...
            modal.find(".title").html("Tambah Alat");
    ...
    $("body").on("click", ".cmd-sunting", function(e)
    {
        ...
        //
            ...
            modal.find(".title").html("Sunting Alat");
            modal.find("button.submit").html("Simpan");
            modal.find("input[type='text']").removeAttr("disabled");
            modal.find("button.cddwn").removeAttr("disabled");
            modal.find("button.submit").removeAttr("disabled");
            ...
            var $URL = config.apps.URL_API + '/api/inventory/tools/show?id='+id;
    ...
    function templateSunting(m,w)
    {
        ...
        form.find("*[name='quantity']").val(rsp.quantity);
        form.find("*[name='kalibrasi_date']").val(rsp.kalibrasi.date);
        form.find("*[name='asset_id']").val(rsp.id);
        form.find("*[name='description']").val(rsp.description);
        form.find("*[name='kalibrasi_status']").val(rsp.kalibrasi.status);
        form.find("*[name='durasi_reminder']").val(rsp.reminder);
        ...
        if( rsp.assesoris !== '')
        {
            var li = '';
            var itemli = '';
            $.each(rsp.assesoris, function(x,y)
            {
                li += '<li ><span>'+y+'</span><a href="#" class="afalse" role="off"><i class="sli_icon-trash"></i></a></li>';
                itemli += y;
            });

            form.find("ul.ul-ass").html(li);
            form.find("*[name='assesoris']").val(JSON.stringify(rsp.assesoris));

        }
        else
        {
            form.find("ul.ul-ass").html('');
            form.find("*[name='assesoris']").val('');
        }

        var area_kalibrasi = form.find("*[name='kalibrasi_status']").parent(".ar-content"),
        kalibrasi_label = area_kalibrasi.find("ul li button[dataid='"+rsp.kalibrasi.status+"'] span").html();


        area_kalibrasi.find("ul li button[dataid='"+rsp.kalibrasi.status+"']").parent("li").attr("aria-selected","true");
        area_kalibrasi.find("button label span").html(kalibrasi_label);
        //
        if(rsp.kalibrasi.status === 1)
        {
            form.find("*[name='kalibrasi_date']").parents(".area-hidden").removeClass("hide");
        }
        else
        {
            form.find("*[name='kalibrasi_date']").parents(".area-hidden").addClass("hide");
        }

        //reminder
        var reminder = form.find("*[name='durasi_reminder']").parent(".area-ddwn"),
    ...
    function checkForm(el)
    {
        ...
        tglkalibrasi = form.find('input[name="kalibrasi_date"]'),
        description = form.find('textarea[name="description"]'),
        kalibrasistatus = form.find('input[name="kalibrasi_status"]'),
        button = form.find('button.submit');
        ...
        //
        if( $.trim(name.val()).length < 3  || $.trim(code.val()) === '' || $.trim(type.val()) === '' || $.trim(quantity.val()) === '' || $.trim(tglkalibrasi.val()) === '' || $.trim(description.val()).length > 0 && $.trim(description.val()).length < 10 )
        {

            //name
            if( $.trim(name.val()).length < 3 )
            {
                name.parent('.ar-content').append('<span class="error">Isikan nama alat sekurangnya 3 karakter</span>');
            ...
            if( $.trim(type.val()) === '')
            {
                type.parent('.ar-content').append('<span class="error">Harap pilih jenis alat</span>');
            ...
            {
                quantity.parents('.ar-content').append('<span class="error">Harap isi jumlah alat</span>');
                quantity.addClass('br-error');
            }

            //tanggal perbaikan
            if( $.trim(kalibrasistatus.val()) === '' )
            {
                kalibrasistatus.parent('.ar-content').append('<span class="error">Pilih status kalibrasi</span>');
                kalibrasistatus.parent('.ar-content').find("button.btn").addClass('br-error');
            }

            if( $.trim(kalibrasistatus.val()) === '1' && $.trim(tglkalibrasi.val()) === '')
            {
                tglkalibrasi.parents('.ar-content').append('<span class="error">Isi tanggal kalibrasi</span>');
                tglkalibrasi.addClass('br-error');
            }

            if( $.trim(description.val()).length > 0 && $.trim(description.val()).length < 10)
            {
                description.parents('.ar-content').append('<span class="error">Isikan detail deskripsi alat sekurangnya 10 karakter</span>');
    ...
    $("#modal-inventory .area-kalibrasi-status li button").click(function()
    {
        var cmd = $(this),
        form = cmd.parents("form");
        ...
        {
            form.find("*[name='kalibrasi_date']").val('');
            durationreminderday(form);
            form.find("*[name='kalibrasi_date']").parents(".area-hidden").removeClass("hide");
            return;
        }
        ...
        durationreminderday(form);
        form.find("*[name='kalibrasi_date']").val('');
        form.find("*[name='kalibrasi_date']").parent(".se-date").attr('role', 'off');
        form.find("*[name='kalibrasi_date']").parents(".area-hidden").addClass("hide");
    });
