        ...
        <div class="in-tables">
            ...
            <div class="div head-tables">
                <div class="div clr-float">
                    ...
                    <form action="/api/news/hibah/table" id="form-table" aria-temp="temp-table">
                    ...
                    <tr>
                        <td class="td-w190 wh-m-520">
                            <div class="td-iner">
                                <div class="div">
                                    ...
                                    <div class="div label">
                                        <span class="ic sli_icon-briefcase fsize10"></span>
                                        <span>{lembaga}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="td-w210 wh-m-520">
                            <div class="td-iner">
                                <div class="div">
                                    <div class="div">
                                        <span class="label fsize9">TGL MULAI</span>
                                    </div>
                                    <span><span class="ic label sli_icon-calendar fsize10"></span>{tglmulai}</span>
                                </div>
                                <div class="div">
                                    <div class="div">
                                        <span class="label fsize9">TGL BERAKHIR</span>
                                    </div>
                                    <span><span class="ic label sli_icon-calendar fsize10"></span>{tglakhir}</span>
                                </div>
                            </div>
                        </td>
                        <td class="td-center td-w70">
        ...
        <div class="modal-content br-rds12 pd-tb15 pd-lr15">
            ...
            <div class="modal-body pd-b0">
                <div class="arinsed mdl-partner pos-rel m-pd-lr25">
                    ...
                    <form action="/api/news/hibah/create" id="form-create" >
                                        ...
                                        <tr>
                                            <td class="left">
                                                <div class="div">
                                                    ...
                                                    <div class="div label">Isikan Nama Hibah dan tentukan jenis peruntukan lembaga
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="vtop">
                                                ...
                                                <div class="div">
                                                    <div class="div hide ws-m-disb-620">
                                                        <b class="up-txt fsize9">NAMA HIBAH</b>
                                                    </div>

                                                    <div class="div ar-content dot-mandatory">
                                                        <input type="text" class="w100p form-control empty" placeholder="Nama Hibah" maxlength="100" name="name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="div">
                                                    ...
                                                    <div class="ddwn area-ddwn ddwn-button-select ar-content keep dot-mandatory w100p area-level" data-label="Jenis Lembaga">
                                                        ...
                                                        <input type="hidden" class="value-dropdown empty" name="lembaga_type" value="">
                                        ...
                                        <tr>
                                            <td class="left">
                                                <div class="div">
                                                    ...
                                                    <div class="div label">Tentukan durasi tanggal hibah dari tanggal mulai hingga tanggal akhir
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="vtop">
                                                ...
                                                <div class="div">
                                                    ...
                                                    <div class="div ar-content dot-mandatory">
                                                        <div class="se-date no-clr w50p" role="off">
                                                            <input type="input" name="startdate" class="w100p form-control background-trf position-rt inputFalseAll empty typefalse" placeholder="Tgl mulai" id="startdate">
                                                            <span class="ar-ic">
                                                ...
                                                <div class="div">
                                                    <div class="div hide ws-m-disb-620">
                                                        <b class="up-txt fsize9">tgl berakhir</b>
                                                    </div>

                                                    <div class="div ar-content dot-mandatory">
                                                        <div class="se-date no-clr w50p" role="off">
                                                            <input type="input" name="enddate" class="w100p form-control background-trf position-rt inputFalseAll empty typefalse" placeholder="Tgl akhir" id="enddate">
                                                            <span class="ar-ic">
                                                                <span class="sli_icon-calendar ic"></span>
                                                            </span>
                                                            <button class="btn-clear clear-date" role="off">
                                    ...
                                    <table>
                                        ...
                                        <tr class="wh-m-620">
                                            <td colspan="2">
                                                ...
                                                <div class="div">
                                                    <span class="label">Isikan uraian informasi hibah</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
...
function createTempTable(e,w)
{
    ...
    $.each(rsp.list,function(i,item)
    {
        ...
        listx = listx.replace('{lembaga}', item.lembaga);
        listx = listx.replace('{notes}', item.text);
        listx = listx.replace('{tglmulai}', item.datex.start.date);
        listx = listx.replace('{tglakhir}', item.datex.end.date);
...
getsublevel('.area-level','Semua Lembaga');
...
$(document).ready(function()
{
    ...
    $(".cmd-modal-create").click(function(e)
    {
        ...
        if(cmd.attr("role") === "off")
        {
            ...
            modal.find(".modal-title span").html("Hibah");
    ...
    $("body").on("click", ".cmd-sunting", function(e)
    {
        ...
        if(cmd.attr("role") === "off")
        {
            ...
            modal.find(".modal-title span").html("Sunting Hibah");

            modal.find("input[name='user_id']").val(getaccount().id);

            var $URL = config.apps.URL_API + '/api/news/hibah/view?id='+id;
    ...
    function templateSunting(m,w)
    {
        ...
        form.find("*[name='startdate']").val(rsp.start);
        form.find("*[name='enddate']").val(rsp.end);
        form.find("*[name='lembaga_type']").val(rsp.type);
        ...
        var type = form.find(".area-level");
        var labeltype = type.find("ul li button[dataid='"+rsp.type+"'] span").html();
        type.find("ul li button[dataid='"+rsp.type+"']").parent("li").attr("aria-selected", "true");
        type.find("button.btn label span").html(labeltype);
        form.find(".se-date").attr("role", "on");
    }


    //SEARCH IN FORM HEADER
    $('body').on('keypress', '#form-table *[name="search"]', function(e)
    {
    ...
    $(".se-date button.clear-date").click(function(e)
    {
        ...
        {
            cmd.attr("role", "on");
            cmd.parent(".se-date").find("input[type='input']").val("");
            cmd.parent(".se-date").attr("role", "off");
            cmd.attr("role", "off");
            cmd.parent(".se-date").find("input[type='input']").focus();
        }
    })
    ...
    function checkFormCreate(w)
    {
        ...
        start = form.find('*[name="startdate"]'),
        end = form.find('*[name="enddate"]'),
        lembagatype = form.find('*[name="lembaga_type"]'),
        ...
        //
        if( $.trim(name.val()).length < 3  || $.trim(start.val()) === '' || $.trim(end.val()) === '' || $.trim(lembagatype.val()) === '' || $.trim(detail1).length === 0 )
        {
            ...
            // lembaga
            if( $.trim(lembagatype.val()) === '' )
            {
                lembagatype.parent('.ar-content').append('<span class="error">Tentukan Jenis Lembaga</span>');
                lembagatype.parent('.ar-content').find('button.btn').addClass('br-error');
            }

            //start
            if( $.trim(start.val()) === '' )
            {
                start.parents('.ar-content').append('<span class="error">Isikan tanggal mulai</span>');
                start.addClass('br-error');
            }

            if( $.trim(end.val()) === '' )
            {
                end.parents('.ar-content').append('<span class="error">Isikan tanggal akhir</span>');
                end.addClass('br-error');
            }

            if( $.trim(detail1).length === 0 )
            {
                vdetail.parent('.ar-content').append('<span class="error">Isikan uraian informasi hibah</span>');
