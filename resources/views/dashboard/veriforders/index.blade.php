                    ...
                    <div class="fl-right">
                        ...
                        <ul>
                            ...
                            <li class="fl-left">
                                ...
                                <form action="/api/veriforder/table" id="form-table" aria-categori="false" data-filter="false">
                                    <div class="ar-li">
...
$(document).ready(function()
{
    ...
    function gettable(e)
    {
        ...
        $.each(e.list, function(i, item)
        {
            ...
            var total = item.payment.total; //item.price_show === 'p' ? item.payment.total : item.payment.total_reseller;
            tagihan = (parseFloat(total) + courier_price) - parseFloat(item.uniq),newTagihan = ViewTagihanAll(total,courier_price,item.uniq,item.promo.total,item.payment.type,cod_cost);
            ...
            li += '<div class="tr">';
                ...
                li += '<div class="thr"><div class="div clr-float">';
                    ...
                    li += '<div class="spcr ws-m-520"><span class="date color-orangered"><b>'+formatRupiah(newTagihan, 'Rp')+'</b></span></div>';
                ...
                li += item.paid === 1 ? '' : '<div class="div expdate hide">JATUH TEMPO PEMBAYARAN: <span class="color-red">'+item.exp+'</span></div>';
                ...
                li += '<div class="tbody"><table><tbody><tr>';
                    ...
                    li += '<td class="td-w180 wh-m-520"><div class="td-iner">';
                        ...
                        li += '<div class="div"><span><b>'+formatRupiah(newTagihan, 'Rp')+'</b></span></div><div class="div"><span class="label">Pembayaran: </span><span>'+item.payment.bank+'</span></div>';
                    ...
                    li += '<td class="td-center td-w70"><div class="td-iner disvis"><div class="div">';
                        ...
                        li += '<a class="btn btn-primary nobr grey s11" href="'+item.invoice_url+'" target="_blank" style="padding:0px 8px;"><span class="fas flaticon2-printer"></span></a>';
                        ...
                        li += '<div class="dropdown">';
                           ...
                           li += '<button type="button" class="btn btn-primary nobr grey s11" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-v"></span></button>';
                            ...
                            li += '<div class="dropdown-menu">';
                                ...
                                li += item.status === "mv" ? '<a class="dropdown-item color-red" data-togglex="modal" msg-type="delete-order" data-target="#msgboxDelOrder" data-invoice="#'+item.invoice+'" href="#" dataid="'+item.id+'" role="off"><span>Batalkan</span><span class="ic sli_icon-trash"></span></a>' : "";
