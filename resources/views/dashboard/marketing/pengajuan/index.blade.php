        ...
        <div class="in-tables">
            ...
            <div class="div head-tables">
                <div class="div clr-float">
                    ...
                    <form action="/api/marketing/pengajuan/table" id="form-table" aria-temp="temp-table">
                        ...
                        <td class="td-w260 wh-m-520">
                            <div class="td-iner">
                                <div class="div">
                                    ...
                                    <span><span class="label ic">SDM:</span>{sdm}</span>
                                </div>
                                <div class="div">
                                    <span>
                                        {tools_status}
                                    </span>
                                    <span><span class="label ic">Alat:</span>{tools}</span>
                                </div>
                            </div>
                        </td>
                        <td class="td-center td-w70">
                                                ...
                                                <div class="divH">
                                                    <div class="tbl">
                                                        <div class="intbl">
                                                            ...
                                                            <button class="btn blue-wth fsize10 hide" role="off">
...
function createTempTable(e,w)
{
    ...
    $.each(rsp.list,function(i,item)
    {
        ...
        listx = listx.replace('{price}', 'Rp.'+formatRupiah(item.price));
        listx = listx.replace('{startdate}', item.startdate);
        listx = listx.replace('{enddate}', item.enddate);
        listx = listx.replace('{register}', (item.progress === 1 ? '<li class="hold"><span>PENDING</span></li>' : ( item.progress === 2 ? '<li class="progress"><span>PROGRESS</span></li>' : '<li class="done"><span>DONE</span></li>' ) ) );
        ...
        listx = listx.replace('{sdm}', item.sdm.label);
        listx = listx.replace('{tools}', item.tools.label);
        listx = listx.replace('{sdm_status}', ( item.sdm.status === 0 ? '<span class="sli_icon-clock color-orange" title="Pending"></span>' : '<span class="sli_icon-check color-green" title="Success"></span>') );

        listx = listx.replace('{tools_status}', ( item.tools.status === 0 ? '<span class="sli_icon-clock color-orange" title="Pending"></span>' : '<span class="sli_icon-check color-green" title="Success"></span>') );
