                    ...
                    <div class="fl-right">
                        ...
                        <ul>
                            ...
                            <li class="fl-right">
                                ...
                                <button class="no cmd-modal-widget green rds4" data-widget="product-stock" data-type="3" role="off" >
                            ...
                            <li class="fl-left">
                                ...
                                <form action="/api/orderstock/table" id="form-table" aria-categori="false" data-filter="false">
                                    <div class="ar-li">
        ...
        $.each(e.list, function(i, item)
        {
            ...
            li += '<div class="tr">';
                ...
                li += '<div class="thr"><div class="div clr-float">';
                    ...
                    li += '<div class="spcr ws-m-520"><span class="date color-orangered"><b>'+formatRupiah(parseFloat(tagihan), 'Rp')+'</b></span></div>';
                    ...
                    li += item.paid === 1 ? '' : '<div class="div expdate">JATUH TEMPO PEMBAYARAN: <span class="color-red">'+item.exp+'</span></div>';
                ...
                li += '<div class="tbody"><table><tbody><tr>';
                    ...
                    li += '<td class="td-w180 wh-m-520"><div class="td-iner">';
                        ...
                        li += '<div class="div"><span><b>'+formatRupiah(tagihan, 'Rp')+'</b></span></div><div class="div"><span>'+item.payment.bank+'</span></div>';
                    ...
                    li += '<td class="td-center td-w70"><div class="td-iner disvis"><div class="div">';
                        ...
                        li += item.payment.type === '' || item.shiping.courier_name === '' ? '' : '<a class="btn btn-primary nobr grey s11" href="'+item.invoice_url+'" target="_blank" style="padding:0px 8px;"><span class="fas flaticon2-printer"></span></a> <div class="div"></div><div class="div" style="height:2px"></div>';
            ...
            $.ajax({
                ...
                success: function(n)
                {
                    ...
                    if( response.status === 2)
                    {
                        ...
                        widget.find('ul.ul-slide').html(li);
                        widget.find('li.slide').attr('role', 'off');
                        elcartwidget(widget,'preview',response);
